...
const ForgotPasswordPage = () => {
  ...
  return (
    <>
      {/* Added SEOHead for forgot password page */}
      <SEOHead 
        title={`Quên mật khẩu - ${domainConfig?.name || 'Trang web'}`}
        description="Khôi phục mật khẩu tài khoản của bạn"
        canonical={`https://${domainConfig?.domain || 'localhost'}/auth/forgot-password`}
      />
