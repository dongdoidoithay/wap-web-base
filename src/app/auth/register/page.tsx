...
const RegisterPage = () => {
  ...
  return (
    <>
      {/* Added SEOHead for register page */}
      <SEOHead 
        title={`Đăng ký - ${domainConfig?.name || 'Trang web'}`}
        description="Tạo tài khoản mới để truy cập các tính năng"
        canonical={`https://${domainConfig?.domain || 'localhost'}/auth/register`}
      />
